...
function fallbackSvg(msg: string): string {
  const P = PAL.dark;
  return `<svg xmlns="http://www.w3.org/2000/svg" width="380" height="60" viewBox="0 0 380 60" role="img" aria-label="commits.sh badge error">
<rect width="380" height="60" rx="10" fill="${P.bg}"/>
<rect x="0.5" y="0.5" width="379" height="59" rx="9.5" fill="none" stroke="${P.line}"/>
<text x="20" y="27" font-family="${MONO}" font-size="12" font-weight="700" fill="${P.text}">commits.sh</text>
